...
| CONF-11 | 任意停止の可否（517/1055/1056 が禁止、1173 が適応的 argmax IG/cost を要求） | SRC-01 / VEA PROTOCOL_LOCK | 現行VEAは fixed-N + McNemar exactを保持。適応停止はcontroller工学または新規preregistered protocolだけに限定 | DEC-004 | **RESOLVED_CURRENT_PROTOCOL**（frozen実験を変更しない） |
...
| CONF-18 | 外部 kernel の e-value 採用は凍結値の変更にあたる | EXTERNAL-001 / loopcell config.yaml / VEA PROTOCOL_LOCK | 現行 frozen VEA/LoopCellには採用禁止。採用する場合は新しいversion/protocolとして事前登録 | DEC-010 | **RESOLVED_CURRENT_PROTOCOL**（2026-09-22） |
